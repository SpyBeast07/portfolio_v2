    ...
    sections: [
        {
            ...
            items: [
                ...
                {
                    text: "Built Portfolio V2, migrating from Next.js to Astro for better performance, content-first architecture, and long-term maintainability — while preserving rich motion and interactivity where it matters.\nTracking industry trends via State of JS 2025:",
                    links: [
